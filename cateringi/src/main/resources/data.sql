...
INSERT INTO Users(userId, email, isActive, password, phoneNumber, userName, userType) values (1,'admin@admin.admin',true,'21232f297a57a5a743894a0e4a801fc3','123123123','admin','ADMIN');
